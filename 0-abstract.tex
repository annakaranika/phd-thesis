...
stack---the \emph{device actuation}, \emph{peer coordination}, and \emph{human interaction} planes.

Our work straddles distributed systems and human-computer interaction. On the
\emph{device actuation plane}, RASC (Request-Ack-Start-Complete) replaces fire-and-forget RPC with an
...
baselines. On the \emph{peer coordination plane}, CoMesh is the first fully decentralized, hub-less
...
cost occupants latency, money, and uptime. On the \emph{human interaction plane}, Control in Context,
