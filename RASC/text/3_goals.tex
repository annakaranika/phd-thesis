...
\begin{figure}[tb]
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        {\includegraphics[width=0.95\textwidth,alt={Illustration of a garage routine in three steps: (i) the garage door opens, (ii) the trashcan is moved out into the driveway, (iii) the garage door closes.}]{RASC/figures/intro/garage-routine-desc.pdf}}
    ...
    \begin{subfigure}[t]{0.47\linewidth}
        \centering
        {\includegraphics[width=\linewidth,alt={Illustration of an action failure in the garage routine: the trashcan gets stuck below the garage door because of an obstacle, so the garage door cannot close.}]{RASC/figures/intro/garage-routine-failure.pdf}}
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        {\includegraphics[width=\textwidth,alt={Illustration of fallback actions in the garage routine: if the first movement fails, the trashcan moves back inside and the garage door then closes.}]{RASC/figures/intro/garage-routine-fallback.pdf}}
