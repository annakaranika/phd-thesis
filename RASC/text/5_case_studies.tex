...
\begin{figure}[tbh]
  ...
  \begin{subfigure}[b]{0.37\linewidth}
    \centering
    \includegraphics[width=\textwidth]{RASC/figures/applications/Reschedule_routines.pdf}
  ...
  \begin{subfigure}[b]{0.34\linewidth}
    \centering
    \includegraphics[width=\textwidth]{RASC/figures/applications/Reschedule_sjfw_out.pdf}
