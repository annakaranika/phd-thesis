...
\begin{figure}[t]
    ...
    \caption{\bf \small Communication between a smart device and a client app. {\it Each arrowed line is an RPC in today's stacks. This chapter replaces dashed lines with the new \abs{} abstraction.}
    }
    \medskip
...
\begin{theorem}[Meeting a Detection Tolerance SLO]
