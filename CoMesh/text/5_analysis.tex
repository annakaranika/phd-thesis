...
\noindent \textbf{Case 3}: If $L_k$ fails after hearing from $R_1$ (lock acquisition/releasing), but before getting a quorum acknowledgment, $R_1$'s \kgroup{} leader will resend the request after a timeout.
...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        ...
        \caption{{\small Availability under different number of simultaneous failures.}}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        ...
        \caption{{\small Impact of different number of groups in the system ($f=5$).}}
        \label{comesh:subfig:prob-varyg}
    \end{subfigure}
    \caption{\bf \small Probability $P(F)$ of \sysname{} running correctly under different parameters. {\it Default $S=100$, $G=30, k=2f+1$.}}
