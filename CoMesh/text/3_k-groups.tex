...
\begin{figure}[tb!]
    ...
    \end{subfigure}
    \caption{\small \it Average quorum distance and \kgroup{} overlap for different system sizes $N$ (2D grid, default $m=2, l=2, r=4$, 40\% smart devices).}
    \medskip
...
\begin{table}[tb!]
    \centering
    \caption{\small \it Average number of \kgroup{} member candidates for different system sizes $N$ (40\% smart devices).}
    \bigskip
