...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.52\textwidth}
        \centering
        \includegraphics[width=\textwidth]{CoMesh/figures/exp_eval/bandwidth_xdev_virt.pdf}
    ...
    \begin{minipage}[b]{0.44\textwidth}
        \includegraphics[width=\textwidth]{CoMesh/figures/exp_eval/client_sync_delay_xdev.png}
