...
This paper focuses on management of such routine-based workloads running over large commercial edge IoT meshes. \Cref{comesh:fig:IoTsetting} (from \ref{intro:sec:background}) shows three emerging edge mesh scenarios---a smart building (b), a smart farm (c), and a smart factory (d).
