...
\begin{figure}[t!]
    ...
    \end{subfigure}
    \caption{\bf \small Three Commercial Edge Settings:
    (a)  \Bldg~\cite{Memoori}, (b)  \Grid~\cite{SMG21}, (c) Smart  Factory~\cite{lampropoulos2019internet}. {\it We later use the \Bldg{} map from (a) and \Grid{} from (b) to drive experiments. }
    }
