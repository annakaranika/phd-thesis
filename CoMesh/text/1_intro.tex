...
\begin{figure}[tb!]
    ...
    \caption{\small \it \sysname{} Programming Workflow: routines are authored in an existing GUI such as the Samsung SmartThings app, and SmartThings' internal JSON is converted to \sysname's JSON specification before being promulgated to devices.}
    \medskip
