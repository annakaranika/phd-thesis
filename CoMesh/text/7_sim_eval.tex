...
\begin{table}[tb!]
    ...
    \begin{tabular}{r l}
        ...
        \hline
    \end{tabular}
    \captionof{table}{\small \it Default parameter values for simulation.
    }
...
\begin{figure}[tb!]
    \centering
    \includegraphics[width=0.75\linewidth]{CoMesh/figures/exp_eval/client_delay_wmobility.pdf}
