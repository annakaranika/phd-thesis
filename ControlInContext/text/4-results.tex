...
\begin{figure}[ht] %{0.5\textwidth}
    \centering
    \includegraphics[width=0.69\linewidth]{ControlInContext/figures/control_schemes_legend_split.pdf}
    \includegraphics[width=0.335\linewidth]{ControlInContext/figures/control_schemes_vs_dev_no_bins.pdf}
    \includegraphics[width=0.3\linewidth]{ControlInContext/figures/control_methods_vs_dev_no_bins.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.55\linewidth]{ControlInContext/figures/control_schemes_legend_split.pdf}
    \par\medskip
...
\begin{table}[t]
    ...
    \footnotesize
    \begin{tabular}{R{3.5cm}|p{5.8cm}|p{6cm}}
        \hline
