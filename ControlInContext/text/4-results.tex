...
\begin{figure}[ht]
    ...
    \caption{Survey: number of smart home apps installed vs.\ number of devices owned. Points are participants (black X = per-group median); the red line is the CDF over the number of installed apps. Most participants keep only 1--4 apps even as device counts grow.}
    \medskip
...
\begin{table}[t]
    \centering
    \caption{\it Survey: common reasons participants gave for why they controlled a device in a particular way ($N=43$ valid survey responses).}
    \bigskip
    ...
    \begin{tabular}{l c p{8cm}}
        ...
        \hline\hline
        Ease of use & 8 (19\%) & ``It's the simplest and easiest way to use.'' \\
        Location of device & 9 (21\%) & ``If I am nearby I use touch controls, otherwise voice commands.'' \\
        Maximize device control & 13 (30\%) & ``Complete control over the entire system, without using 10 apps.'' \\
        As a backup plan & 12 (28\%) & ``If Alexa isn't working to ask to turn on we can use the app.'' \\
        Force of habit & 4 (9\%) & ``Voice commands are easier than to hunt out the app on my phone.'' \\
        \hline
    \end{tabular}
\end{table}
