...
\begin{table}[t!]
    \caption{\bf \small Summary of Survey Participant Demographics.}
    \bigskip
...
\begin{table}[t]
    \centering
    \caption{\bf \small Smart device ownership of our 8 interview participants. {\it For each smart device, an `x' indicates that the participant owns that device in their home. }}
    \bigskip
...
\begin{table}
    \footnotesize
    \centering
    \caption{\bf \small Codebook generated from qualitative analysis.}
    \bigskip
