...
Collectively, this work turns three planes of smart-space control---the device actuation plane (how actions are observed and programmed), the peer coordination plane (where control logic runs), and the human interaction plane (how occupants interact with it)---from sources of fragility and frustration into design targets shaped by the needs of the people who inhabit the space.
